...
export const localStorageService = {
  ...
  initializeAppData: (): void => {
    ...
    const initialRecipes: Recipe[] = [
      ...
      // 7 recettes ajoutées précédemment
      {
        id: '11',
        name: 'Chebakia',
        nameAr: 'الشباكية',
      ...
      // 7 nouvelles recettes
      {
        ...
        nameAr: 'الحريرة',
        regionId: '7', // Marrakech-Safi
        description: 'Soupe traditionnelle servie pendant le Ramadan pour rompre le jeûne, riche en légumineuses, légumes et épices.',
        ingredients: [
        ...
        steps: [
          'Dans une grande marmite, faire revenir la viande avec les oignons hachés dans un peu d\'huile d\'olive.',
          'Ajouter les épices, les herbes hachées (en gardant un peu pour la garniture) et les tomates concassées.',
          'Incorporer le concentré de tomate et couvrir d\'eau (environ 2 litres).',
          'Ajouter les pois chiches et porter à ébullition, puis laisser mijoter 1 heure à couvert.',
          'Ajouter les lentilles et poursuivre la cuisson pendant 30 minutes.',
          'Dans un bol, délayer la farine avec un peu d\'eau froide pour obtenir une pâte lisse.',
          'Verser progressivement cette préparation dans la soupe en remuant constamment pour éviter les grumeaux.',
          'Ajouter les vermicelles et poursuivre la cuisson 10 minutes.',
          'Avant de servir, ajouter le jus de citron et rectifier l\'assaisonnement.',
          'Servir chaud, garni d\'herbes fraîches ciselées.',
        ],
        imageUrl: '/harira.jpg',
        category: 'entrée',
        preparationTime: 30,
      ...
      },
      {
        ...
        nameAr: 'المعقودة',
        regionId: '1', // Tanger-Tétouan-Al Hoceïma
        description: 'Galettes de pommes de terre épicées, frites, très populaires comme en-cas de rue ou servies pendant le Ramadan.',
        ingredients: [
        ...
        steps: [
          'Éplucher et couper les pommes de terre en morceaux, puis les faire cuire à l\'eau bouillante salée jusqu\'à ce qu\'elles soient tendres.',
          'Égoutter et écraser les pommes de terre en purée.',
          'Ajouter l\'ail, les herbes hachées, les épices, le sel et le poivre.',
          'Incorporer les œufs battus et la farine pour lier la préparation.',
          'Laisser reposer le mélange au réfrigérateur pendant au moins 30 minutes.',
          'Former des galettes rondes et plates d\'environ 7 cm de diamètre.',
          'Faire chauffer l\'huile dans une poêle et y faire frire les galettes jusqu\'à ce qu\'elles soient dorées des deux côtés.',
          'Égoutter sur du papier absorbant.',
          'Servir chaud, accompagné d\'une sauce harissa ou dans un sandwich.',
        ],
      ...
      },
      {
        ...
        nameAr: 'المروزية',
        regionId: '7', // Marrakech-Safi
        description: 'Tajine d\'agneau sucré-salé aux raisins secs, au miel et aux épices, traditionnellement préparé pendant l\'Aïd al-Adha.',
        ingredients: [
        ...
        steps: [
          'Dans un tajine ou une cocotte, faire chauffer l\'huile et le beurre, puis faire dorer les morceaux d\'agneau de tous côtés.',
          'Ajouter les oignons émincés et faire revenir jusqu\'à ce qu\'ils soient translucides.',
          'Incorporer toutes les épices, le sel et le poivre, bien mélanger.',
          'Couvrir d\'eau à hauteur et laisser mijoter à couvert pendant 1h30, jusqu\'à ce que la viande soit tendre.',
          'Pendant ce temps, faire tremper les raisins secs dans de l\'eau tiède pendant 15 minutes, puis les égoutter.',
          'Faire griller les amandes dans une poêle sans matière grasse jusqu\'à ce qu\'elles soient dorées.',
          'Quand la viande est tendre, ajouter les raisins secs et le miel.',
          'Poursuivre la cuisson à découvert pendant 20-30 minutes, jusqu\'à ce que la sauce épaississe.',
          'Avant de servir, parsemer d\'amandes grillées.',
          'Servir chaud, accompagné de couscous ou de pain.',
        ],
        imageUrl: '/mrouzia.jpg',
        category: 'plat',
        preparationTime: 30,
        cookingTime: 150,
        servings: 6,
        difficulty: 'moyen',
        createdAt: 1761234567890,
        createdBy: '1',
      },
      {
        id: '21',
        ...
        description: 'Plat festif à base de couches de msemen (crêpes feuilletées) servies avec une sauce riche de volaille et de lentilles.',
        ingredients: [
          '1 poulet entier',
          ...
          '1/2 cuillère à café de curcuma',
          '1 pincée de safran',
          '10-12 feuilles de msemen (crêpes feuilletées marocaines)',
          '3 cuillères à soupe d\'huile d\'olive',
          '50g de beurre',
          'Sel et poivre',
        ],
        steps: [
          'Faire tremper les lentilles dans de l\'eau froide pendant 2 heures, puis les égoutter.',
          'Dans une grande marmite, faire revenir le poulet avec les oignons hachés dans l\'huile d\'olive.',
          'Ajouter les épices, les tomates, la moitié des herbes hachées, le sel et le poivre.',
          'Couvrir d\'eau et laisser mijoter à feu moyen pendant 45 minutes.',
          'Ajouter les lentilles et poursuivre la cuisson pendant 30 minutes, jusqu\'à ce que le poulet et les lentilles soient tendres.',
          'Retirer le poulet, détacher la chair des os et la couper en morceaux.',
          'Réchauffer les feuilles de msemen au four ou à la vapeur pour qu\'elles soient souples.',
          'Dans un grand plat, disposer les feuilles de msemen en couches, en arrosant chaque couche avec la sauce aux lentilles.',
          'Répartir les morceaux de poulet sur le dessus.',
          'Arroser de sauce et parsemer du reste des herbes hachées avant de servir.',
        ],
        imageUrl: '/trid.jpg',
        category: 'plat',
        preparationTime: 40,
      ...
      },
      {
        ...
        nameAr: 'كعب الغزال',
        regionId: '3', // Fès-Meknès
        description: 'Pâtisserie en forme de croissant garnie de pâte d\'amande parfumée à l\'eau de fleur d\'oranger, connue sous le nom de "cornes de gazelle".',
        ingredients: [
          'Pour la pâte:',
          '500g de farine',
        ...
        steps: [
          'Préparer la pâte en mélangeant la farine, le beurre et le sel jusqu\'à obtenir une texture sablée.',
          'Ajouter l\'eau de fleur d\'oranger et pétrir jusqu\'à obtenir une pâte souple.',
          'Laisser reposer la pâte sous un linge pendant 30 minutes.',
          'Pour la farce, mélanger les amandes moulues avec le sucre glace.',
          'Ajouter l\'eau de fleur d\'oranger, l\'eau de rose et le beurre fondu, bien mélanger pour obtenir une pâte homogène.',
          'Étaler la pâte finement et découper des cercles de 10 cm de diamètre environ.',
          'Déposer une cuillère à café de farce d\'amandes sur chaque cercle.',
          'Replier la pâte pour former un croissant et bien sceller les bords.',
          'Façonner délicatement chaque croissant en lui donnant une forme légèrement incurvée.',
          'Cuire au four préchauffé à 180°C pendant 15-20 minutes jusqu\'à ce que les gâteaux soient légèrement dorés.',
          'Laisser refroidir puis saupoudrer généreusement de sucre glace avant de servir.',
        ],
        imageUrl: '/kaab-el-ghazal.jpg',
        category: 'dessert',
        preparationTime: 60,
        cookingTime: 20,
        servings: 24,
      ...
      },
      {
        ...
        nameAr: 'الرفيسة',
        regionId: '4', // Rabat-Salé-Kénitra
        description: 'Plat traditionnel à base de poulet, de lentilles et de msemen émietté, souvent préparé pour les nouvelles mamans après l\'accouchement.',
        ingredients: [
          ...
          '500g de msemen (crêpes feuilletées marocaines)',
          '3 cuillères à soupe d\'huile d\'olive',
          '50g de beurre',
          'Sel et poivre',
        ],
        steps: [
          'La veille, faire tremper le fenugrec dans de l\'eau froide.',
          'Dans une grande marmite, faire revenir le poulet avec les oignons dans l\'huile d\'olive.',
          'Ajouter l\'ail, la moitié de la coriandre ciselée et toutes les épices.',
          'Couvrir d\'eau et laisser mijoter à feu moyen pendant 45 minutes.',
          'Ajouter les lentilles égouttées et le fenugrec égoutté, poursuivre la cuisson pendant 30 minutes.',
          'Pendant ce temps, réchauffer légèrement les msemen puis les déchirer en petits morceaux.',
          'Dans un grand plat, disposer les morceaux de msemen.',
          'Arroser généreusement avec le bouillon de cuisson.',
          'Répartir les morceaux de poulet, les lentilles et le fenugrec sur le dessus.',
          'Parsemer de coriandre fraîchement ciselée et arroser de beurre fondu avant de servir.',
        ],
        imageUrl: '/rfissa.jpg',
        category: 'plat',
        preparationTime: 45,
